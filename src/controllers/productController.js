const { CreateProductService, ReadAllProductService, ReadSingleProductService, UpdateProductService, DeleteProductService, DeleteAllProductService } = require("../services/productService");
